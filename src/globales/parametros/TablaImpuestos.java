...
public class TablaImpuestos implements TableModel
{
	private LinkedList datos = new LinkedList();
	private LinkedList listeners = new LinkedList();
	private ModeloImpuestos aux = new ModeloImpuestos();
	...
	{
		ModeloImpuestos aux = (ModeloImpuestos)this.datos.get(rowIndex);
		switch (columnIndex)
		{
		case 0:
			return aux.getId();
	...
	public void anhade(ModeloImpuestos nuevo)
	{
	...
	public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
		this.aux = ((ModeloImpuestos)this.datos.get(rowIndex));
		switch (columnIndex)
		{
		case 0:
			...
			break;
		case 1:
			this.aux.setDescripcion((String)aValue);
			break;
		}
